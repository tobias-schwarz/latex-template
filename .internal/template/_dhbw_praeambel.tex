...
\usepackage[                % Biblatex
  backend=biber,
  bibstyle=.internal/template/_dhbw_authoryear,maxbibnames=99,
  citestyle=authoryear,
  uniquename=true, useprefix=true,
  bibencoding=utf8]{biblatex}
\input{.internal/template/_dhbw_biblatex-config.tex} % mit DHBW-spezifischen Einstellungen
...
\input{.internal/template/_dhbw_kopfzeilen.tex}		 % für schöne Kopfzeilen 
