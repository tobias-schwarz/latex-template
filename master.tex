...
\input{.internal/template/_dhbw_praeambel.tex}

%%% Name der eigenen Literatur-Datenbank %%%
\bibliography{lib/bibliography/bibliography.bib}

\begin{document}

%%% Deckblatt einbinden %%% 
\input{src/deckblatt.tex}
...
%%% Erklärung %%%
\input{.internal/template/_dhbw_erklaerung.tex}
